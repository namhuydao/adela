                            ...
                            <form action="#">
                                <div class="table-content table-responsive">
                                    <table>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="product-thumbnail"><a href="#"><img src="../../../../public/site/images/cart/1.jpg"
                                                            alt="man" /></a></td>
                                            ...
                                            <tr>
                                                <td class="product-thumbnail"><a href="#"><img src="../../../../public/site/images/cart/2.jpg"
                                                            alt="man" /></a></td>
                                                <td class="product-name"><a href="#">Áo Len Dài Tay Nữ</a></td>
                                                <td class="product-price"><span class="amount">499,000đ</span></td>
                                                <td class="product-quantity"><input type="number" value="1"></td>
                                                <td class="product-subtotal">499,000đ</td>
                                                <td class="product-remove"><a href="#"><i class="fa fa-times"></i></a>
                        ...
                        <div class="col-12 col-md-6 col-lg-5">
                            <div class="cart_totals">
                                ...
                                <div class="wc-proceed-to-checkout">
                                    <a href="../checkout/checkout.php">Tiến Hành Thanh Toán</a>
                                </div>
                            </div>
                        </div>
                    </div>
