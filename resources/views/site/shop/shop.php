                                    ...
                                    <ul>
                                        ...
                                        <li><a href="shop.php">Nam</a>
                                            <ul class="mega-menu">
                                                ...
                                                <li><a href="shop.php">sản phẩm đặc biệt</a>
                                                    <ul class="sub-menu-2">
                                                        <li><a href="shop.php">chống nắng</a></li>
                                                        <li><a href="shop.php">SP đạt chứng chỉ an toàn</a></li>
                                                        <li><a href="shop.php">thoát ẩm vượt trội</a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li><a href="shop.php">Nữ</a>
                                            <ul class="mega-menu">
                                                ...
                                                <li><a href="shop.php">sản phẩm đặc biệt</a>
                                                    <ul class="sub-menu-2">
                                                        <li><a href="shop.php">len lông dê cashmere</a></li>
                                                        <li><a href="shop.php">len lông cừu úc</a></li>
                                                        <li><a href="shop.php">chống nắng</a></li>
                                                        <li><a href="shop.php">SP đạt chứng chỉ an toàn</a></li>
                                                    </ul>
                                                </li>
                                        ...
                                        <li><a href="../blog/blog.blade.php">Tin Tức</a></li>
                                        ...
                                        <div class="mini-cart-sub">
                                            <div class="cart-product">
                                                <div class="single-cart">
                                                    <div class="cart-img">
                                                        <a href="product-details.php"><img src="../../../../public/site/images/product/1.jpg"
                                                                                           alt="book" /></a>
                                                    </div>
                                                    <div class="cart-info">
                                                ...
                                                <div class="single-cart">
                                                    <div class="cart-img">
                                                        <a href="product-details.php"><img src="../../../../public/site/images/product/3.jpg"
                                                                                           alt="book" /></a>
                                                    </div>
                                                    <div class="cart-info">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="th">
                                    ...
                                    <div class="product-wrapper product-wrapper-3 mb-40">
                                        <div class="product-img">
                                            <a href="product-details.php">
                                                <img src="../../../../public/site/images/product/1.jpg" alt="product" class="primary">
                                                <img src="../../../../public/site/images/product/2.jpg" alt="product" class="secondary">
                                            </a>
                                        ...
                                        <div class="product-content">
                                            ...
                                            <p>Áo len phom dáng Slim Fit ôm gọn gàng, tôn dáng và ấm áp. Thiết kế cổ
                                                tròn basic, bo gấu và tay áo gọn gàng. Mặt trước dệt đan xen tạo điểm
                                                nhấn ấn tượng. Màu sắc trẻ trung kết
                                                hợp hiệu ứng màu melange mang đến diện mạo thu hút cho người mặc..</p>
                                        </div>
                                    </div>
                                    <!-- product-wrapper end -->
                                    <!-- product-wrapper start -->
                                    <div class="product-wrapper product-wrapper-3 mb-40">
                                        <div class="product-img">
                                            <a href="product-details.php">
                                                <img src="../../../../public/site/images/product/3.jpg" alt="product" class="primary" />
                                                <img src="../../../../public/site/images/product/4.jpg" alt="product" class="secondary" />
                                            </a>
                                            <div class="product-icon">
                                                <a href="#" data-toggle="tooltip" title="Thêm vào Giỏ Hàng"><i
                                                        class="icon ion-bag"></i></a>
                                        ...
                                        <div class="product-content">
                                            ...
                                            <h2><a href="product-details.php">Áo Len Dài Tay Nữ</a></h2>
                                            <div class="price">
                                                <ul>
                                                    <li class="new-price">499,000đ</li>
                                                </ul>
                                            </div>
                                            <p>Áo len sợi dày ánh kim đính hạt trang trí.
                                                Phom regular, cổ tròn, tay dài. Phù hợp mặc mùa đông, kiểu dáng thời
                                                trang, cá tính phù hợp nhiều hoàn cảnh.
                                                Dễ dàng kết hợp với quần jeans, chân váy, giày bệt, thể thao..</p>
                                        </div>
                                    </div>
                                    <!-- product-wrapper end -->
                                    <!-- product-wrapper start -->
                                    <div class="product-wrapper product-wrapper-3 mb-40">
                                        <div class="product-img">
                                            <a href="product-details.php">
                                                <img src="../../../../public/site/images/product/5.jpg" alt="product" class="primary" />
                                                <img src="../../../../public/site/images/product/6.jpg" alt="product" class="secondary" />
                                            </a>
                                            <span class="sale">sale</span>
                                            <div class="product-icon">
                                                <a href="#" data-toggle="tooltip" title="Thêm vào Giỏ Hàng"><i
                                        ...
                                        <div class="product-content">
                                            ...
                                            <h2><a href="product-details.php">Váy Len Mỏng Dài Tay</a></h2>
                                            <div class="price">
                                                <ul>
                                            ...
                                            <p>Váy len nữ họa tiết kẻ ngang. Thiết kế dáng regular, tay dài buộc nơ,
                                                chất liệu mềm mại, nhẹ nhàng, ấm áp và không gây tích điện..</p>
                                        </div>
                                    </div>
                                    <!-- product-wrapper end -->
                                    <!-- product-wrapper start -->
                                    <div class="product-wrapper product-wrapper-3 mb-40">
                                        <div class="product-img">
                                            <a href="product-details.php">
                                                <img src="../../../../public/site/images/product/7.jpg" alt="product" class="primary" />
                                                <img src="../../../../public/site/images/product/8.jpg" alt="product" class="secondary" />
                                            </a>
                                            <div class="product-icon">
                                                <a href="#" data-toggle="tooltip" title="Thêm vào Giỏ Hàng"><i
                                                        class="icon ion-bag"></i></a>
                                        ...
                                        <div class="product-content">
                                            ...
                                            <h2><a href="product-details.php">Áo Khoác Nam Mặc Nhà</a> </h2>
                                            <div class="price">
                                                <ul>
                                                    <li class="new-price">449,000đ</li>
                                                </ul>
                                            </div>
                                            <p>Áo khoác nam mặc nhà dáng regular, phối màu ở cổ và tay áo. Chất liệu dày
                                                dặn, ấm áp vào mùa đông..</p>
                                        </div>
                                    </div>
                                    <!-- product-wrapper end -->
                                    <!-- product-wrapper start -->
                                    <div class="product-wrapper product-wrapper-3 mb-40">
                                        <div class="product-img">
                                            <a href="product-details.php">
                                                <img src="../../../../public/site/images/product/9.jpg" alt="product" class="primary" />
                                                <img src="../../../../public/site/images/product/10.jpg" alt="product" class="secondary" />
                                            </a>
                                            <div class="product-icon">
                                                <a href="#" data-toggle="tooltip" title="Thêm vào Giỏ Hàng"><i
                                                        class="icon ion-bag"></i></a>
                                        ...
                                        <div class="product-content">
                                            ...
                                            <h2><a href="product-details.php">Áo Nỉ Nữ In Hình</a></h2>
                                            <div class="price">
                                                <ul>
                                                    <li class="new-price">349,000đ</li>
                                                </ul>
                                            </div>
                                            <p>Áo nỉ nữ in hình, dáng regular, cổ tròn, tay dài. Chất liệu mềm mại,ấm áp
                                                về mùa đông..</p>
                                        </div>
                                    </div>
                                    <!-- product-wrapper end -->
                                    ...
                                    <div class="product-wrapper product-wrapper-3 mb-40">
                                        <div class="product-img">
                                            <a href="product-details.php">
                                                <img src="../../../../public/site/images/product/11.jpg" alt="product" class="primary" />
                                                <img src="../../../../public/site/images/product/12.jpg" alt="product" class="secondary" />
                                            </a>
                                            <span class="sale">sale</span>
                                            <div class="product-icon">
                                                <a href="#" data-toggle="tooltip" title="Thêm vào Giỏ Hàng"><i
                                        ...
                                        <div class="product-content">
                                            ...
                                            <p>Quần jogger nam dáng regular, bo gấu, cạp chun, có giây rút, túi chéo và
                                                túi hộp 2 bên. Chất liệu có độ bền cao, ít khả năng bị nấm mốc, đàn hồi
                                                và giữ nhiệt tốt, đem lại sự thoải mái cho người mặc trong mọi
                                                hoạt động..</p>
                                        </div>
                                    </div>
                                    <!-- product-wrapper end -->
                                    ...
                                    <div class="product-wrapper product-wrapper-3">
                                        <div class="product-img">
                                            <a href="product-details.php">
                                                <img src="../../../../public/site/images/product/13.jpg" alt="product" class="primary" />
                                                <img src="../../../../public/site/images/product/14.jpg" alt="product" class="secondary" />
                                            </a>
                                            <div class="product-icon">
                                                <a href="#" data-toggle="tooltip" title="Thêm vào Giỏ Hàng"><i
                                                        class="icon ion-bag"></i></a>
                                        ...
                                        <div class="product-content">
                                            ...
                                            <p>Áo sơ mi Cotton USA, phom dáng Regular fit, cổ tàu cài khuy, tay dài có
                                                măng séc, gấu đuôi tôm, đơn giản, mộc mạc. Phù hợp nhiều hoàn cảnh. Kết
                                                hợp với quần kaki, jeans, với sandal, giày bệt...</p>
                                        </div>
                                    </div>
                                    <!-- product-wrapper end -->
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4">
                                            ...
                                            <div class="product-wrapper mb-40">
                                                <div class="product-img">
                                                    <a href="product-details.php">
                                                        <img src="../../../../public/site/images/product/3.jpg" alt="product" class="primary" />
                                                        <img src="../../../../public/site/images/product/4.jpg" alt="product"
                                                             class="secondary" />
                                                    </a>
                                                    <div class="product-icon">
                                                        <a href="#" data-toggle="tooltip" title="Thêm vào Giỏ Hàng"><i
                                        ...
                                        <div class="col-12 d-md-none d-lg-block col-lg-4">
                                            ...
                                            <div class="product-wrapper mb-40">
                                                <div class="product-img">
                                                    <a href="product-details.php">
                                                        <img src="../../../../public/site/images/product/5.jpg" alt="product" class="primary" />
                                                        <img src="../../../../public/site/images/product/6.jpg" alt="product"
                                                             class="secondary" />
                                                    </a>
                                                    <span class="sale">sale</span>
                                                    <div class="product-icon">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4">
                                            ...
                                            <div class="product-wrapper mb-40">
                                                <div class="product-img">
                                                    <a href="product-details.php">
                                                        <img src="../../../../public/site/images/product/7.jpg" alt="product" class="primary" />
                                                        <img src="../../../../public/site/images/product/8.jpg" alt="product"
                                                             class="secondary" />
                                                    </a>
                                                    <div class="product-icon">
                                                        <a href="#" data-toggle="tooltip" title="Thêm vào Giỏ Hàng"><i
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4">
                                            ...
                                            <div class="product-wrapper mb-40">
                                                <div class="product-img">
                                                    <a href="product-details.php">
                                                        <img src="../../../../public/site/images/product/19.jpg" alt="product"
                                                             class="primary" />
                                                        <img src="../../../../public/site/images/product/20.jpg" alt="product"
                                                             class="secondary" />
                                                    </a>
                                                    <div class="product-icon">
                                                        <a href="#" data-toggle="tooltip" title="Thêm vào Giỏ Hàng"><i
                                                ...
                                                <div class="product-content pt-20">
                                                    ...
                                                    <h2><a href="product-details.php">Áo Mặc Nhà Nữ</a></h2>
                                                    <div class="price">
                                                        <ul>
                                        ...
                                        <div class="col-12 d-md-none d-lg-block col-lg-4">
                                            ...
                                            <div class="product-wrapper mb-40">
                                                <div class="product-img">
                                                    <a href="product-details.php">
                                                        <img src="../../../../public/site/images/product/11.jpg" alt="product"
                                                             class="primary" />
                                                        <img src="../../../../public/site/images/product/12.jpg" alt="product"
                                                             class="secondary" />
                                                    </a>
                                                    <span class="sale">sale</span>
                                                    <div class="product-icon">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4">
                                            ...
                                            <div class="product-wrapper">
                                                <div class="product-img">
                                                    <a href="product-details.php">
                                                        <img src="../../../../public/site/images/product/13.jpg" alt="product"
                                                             class="primary" />
                                                        <img src="../../../../public/site/images/product/14.jpg" alt="product"
                                                             class="secondary" />
                                                    </a>
                                                    <div class="product-icon">
                                                        <a href="#" data-toggle="tooltip" title="Thêm vào Giỏ Hàng"><i
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4">
                                            ...
                                            <div class="product-wrapper">
                                                <div class="product-img">
                                                    <a href="product-details.php">
                                                        <img src="../../../../public/site/images/product/15.jpg" alt="product"
                                                             class="primary" />
                                                        <img src="../../../../public/site/images/product/16.jpg" alt="product"
                                                             class="secondary" />
                                                    </a>
                                                    <span class="sale">sale</span>
                                                    <div class="product-icon">
                                        ...
                                        <div class="col-12 d-md-none d-lg-block col-lg-4">
                                            ...
                                            <div class="product-wrapper">
                                                <div class="product-img">
                                                    <a href="product-details.php">
                                                        <img src="../../../../public/site/images/product/17.jpg" alt="product"
                                                             class="primary" />
                                                        <img src="../../../../public/site/images/product/18.jpg" alt="product"
                                                             class="secondary" />
                                                    </a>
                                                    <div class="product-icon">
                                                        <a href="#" data-toggle="tooltip" title="Thêm vào Giỏ Hàng"><i
                        ...
                        <div class="modal-body">
                            <div class="modal-img">
                                <div class="single-img">
                                    <a href="product-details.php"><img src="../../../../public/site/images/product/1.jpg" alt="product"
                                                                       class="primary" /></a>
                                </div>
                            </div>
