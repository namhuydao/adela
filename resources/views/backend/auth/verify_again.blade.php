...
<head>
    ...
    <title>Adela| Verify email</title>
                        ...
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            ...
                            <div class="card-body">
                                <div class="alert alert-success" role="alert">
                                    Link kích hoạt tài khoản mới đã được gửi đến Email của bạn
                                </div>
                                <p>Nếu bạn vẫn chưa nhận được Email</p>
                                <form class="d-inline" method="POST" action="{{ route('resend') }}">
                                    @csrf
                                    <button type="submit"
                                            class="btn btn-link p-0 m-0 align-baseline">Click vào đây để yêu cầu link
                                        mới
                                    </button>
                                </form>
                            </div>
